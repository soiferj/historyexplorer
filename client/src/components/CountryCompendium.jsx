...
function CountryCompendium({ events, isAllowed }) {
  ...
  const countriesByContinent = useMemo(() => {
    ...
    Array.from(set).forEach(country => {
      let continent = countryToContinent[country.toLowerCase()];
      if (!continent) {
        continent = "Unknown";
